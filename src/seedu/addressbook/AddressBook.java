...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Sort all persons in alphabetical order according to their names.";
     ...
     */
    private static Collection<String> changeToLowerCase(Collection<String> originalWords){
    ...
    /**
     * Sort the list of person in the address book by alphabetical order
     *
     *
     */
    private static String executeSortPersons(){
        ALL_PERSONS.sort(Comparator.comparing(p -> p.get(PersonProperty.NAME)));
        return executeListAllPersonsInAddressBook();
    }
    ...
    */
    ...
    private static String removePrefix(String fullString, String prefix) {
        ...
        //change from string.replace to string.replaceFirst
    }
